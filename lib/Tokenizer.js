...
var decodeCodePoint = require("entities/lib/decode_codepoint.js"),
    ...
    IN_END_OPEN_CONDITIONAL_COMMENT    = i++,
...
Tokenizer.prototype._stateInOpenConditionalComment = function(c){
  if ((this._index - this._sectionStart === 3) &&
      this._buffer.substring(this._sectionStart, this._index) !== '[if') {
    this._state = IN_COMMENT;
  } else if(c === ">"){
    this._state = IN_END_OPEN_CONDITIONAL_COMMENT;
  }
};
...
Tokenizer.prototype._parse = function(){
  while(this._index < this._buffer.length && this._running){
    ...
    */
    ...
    } else if(this._state === IN_END_OPEN_CONDITIONAL_COMMENT){
      this._stateInEndOpenConditionalComment(c);
